...
import 'daro_banner_ad.dart';
import 'daro_banner_size.dart';

class DaroBannerAdWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!AdInstanceManager.instance.isReadyForView(ad.adId)) {
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ErrorSummary('DaroBannerAdWidget requires ad.load() to be called before inserting into the widget tree'),
