...
class DaroAppOpenAdManager: NSObject, FlutterStreamHandler {
    private var eventSink: FlutterEventSink?
    private var adLoaders: [String: DaroAppOpenAdLoader] = [:]
    private var ads: [String: DaroAppOpenAd] = [:]
    ...
    private func loadAd(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        let loader = DaroAppOpenAdLoader(unit: adUnit)
