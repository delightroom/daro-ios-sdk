...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Daro",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/1.1.57-alpha-pre.1/Daro.xcframework.zip",
            checksum: "513e3e60eb7c0743d165c861045b81c055849b4d1d4bbfaef64d0f11ef8b317b"
        ),
        .target(
            name: "DaroAds",
            dependencies: [
