...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-dtexchange.git",      exact: "8.3.800"),
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-chartboost.git",      exact: "9.11.1"),
        ...
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-mintegral.git",       exact: "7.7.900"),
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-moloco.git",          exact: "4.1.0"),
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-line.git",            exact: "2.9.2025111900"),
        .package(url: "https://github.com/googleads/googleads-mobile-ios-mediation-unity.git",           exact: "4.16.0"),
    ],
    targets: [
        .binaryTarget(
            name: "Daro",
            url: "https://github.com/delightroom/daro-ios-sdk/releases/download/1.1.55-alpha/Daro.xcframework.zip",
            checksum: "88f4a78236dd65883be7392d626e96b724489cd3ecf4e38ec69253276e6af4b0"
        ),
        .target(
            name: "DaroAds",
            dependencies: [
